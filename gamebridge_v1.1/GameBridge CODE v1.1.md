...
KOPPLINGAR:
 - HÄMTAR FRÅN: interface/audio_io.py, adapters/adapter_loader.py,
   ai/ollama_client.py, ai/ai_lifecycle_core.py,
   core/channel_matrix.py, interface/hardware_io.py,
...
class GameBridgeCore:
    ...
    def process_chatt_flow(self, user_text: str):
        ...
        interaction_id = self.user_interaction_core.start(user_text)
...
def function_pipeline_worker(
    ...
    try:
        ...
        while True:
            ...
            # =====================================================================
            #
            # GameBridge har nu dumpat/dispatchat aktuellt steg.
            #
            # OllamaClient får kvittot och bestämmer själv nästa steg.
            # =====================================================================
...
{"timestamp": "2026-09-07T11:02:56.019334+02:00", "session_id": "default", "query": "hej jag vill veta vädret i stockholm idag, använd endast en källa", "provider": "tavily", "success": true, "result_count": 3, "error": null}
...
When no supported Notepad++ interaction is required:
...
Telemetry is read-only information. Do not use an action to obtain
information that is already available through telemetry.
